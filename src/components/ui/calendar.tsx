    ...
    return (
        <DayPicker
            ...
            classNames={{
                ...
                day_selected:
                    "bg-indigo-600 text-slate-50 hover:bg-indigo-600 hover:text-slate-50 focus:bg-indigo-600 focus:text-slate-50 dark:bg-indigo-50 dark:text-slate-900 dark:hover:bg-indigo-50 dark:hover:text-slate-900 dark:focus:bg-indigo-50 dark:focus:text-slate-900",
                ...
                day_range_middle:
                    "aria-selected:bg-indigo-50 aria-selected:text-slate-900 dark:aria-selected:bg-slate-800 dark:aria-selected:text-slate-50",
